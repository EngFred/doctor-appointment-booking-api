...
// Rate limit for completing appointments
...
router.get('/:id/messages', protect, getLimiter, appointmentController.getMessages);
...
router.post('/:id/message', protect, sendMessageLimiter, appointmentController.sendMessage);
